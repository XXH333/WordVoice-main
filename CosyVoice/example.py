...
def cosyvoice3_example():
    ...
    """
    cosyvoice = AutoModel(
        model_dir='/workspace/project-cpfs-1000109/niesihang/wordvoice/checkpoints/Fun-CosyVoice3-0.5B',
        llm_path='/workspace/project-cpfs-1000109/niesihang/wordvoice/train_results/exp/cosyvoice3_llm/epoch_0_whole.pt'
    )
    # zero_shot usage
